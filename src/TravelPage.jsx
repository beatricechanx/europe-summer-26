...
const cities = [
  {
    ...
    hotelNote: "Am Hof 2, 1010",
    weather: "25–34°C · 偶有雷陣雨",
    trainRef: "",
    accent: MORANDI.sage,
  ...
  },
  {
    ...
    dates: "7/13 — 7/15",
    hotel: "Andaz Prague",
    hotelNote: "Senovážné nám., 近主車站",
    weather: "23–32°C · 午後雷陣雨機會高",
    trainRef: "",
    accent: MORANDI.dustyRose,
  ...
  },
  {
    ...
    hotelNote: "Hyatt · 5th District · Pest側",
    weather: "25–35°C · 中歐最熱城市",
    trainRef: "",
    accent: MORANDI.slate,
...
const transport = [
  { from: "Hong Kong (HKG)", to: "Beijing (PEK)", icon: "✈️", flight: "CA 110", detail: "7/10 Fri · 17:45 — 21:15", time: "" },
  { from: "Beijing (PEK)", to: "Vienna (VIE)", icon: "✈️", flight: "CA 841", detail: "7/11 Sat · 02:55 — 06:50", time: "" },
  { from: "Vienna", to: "Prague", icon: "🚂", flight: "ÖBB Train", detail: "7/13 · ~4hr 行程", time: "火車票 Ref:" },
  { from: "Prague", to: "Budapest", icon: "🚂", flight: "ČD Train", detail: "7/15 · 6:00am · ~7hr 行程", time: "火車票 Ref:" },
  { from: "Budapest (BUD)", to: "Beijing (PEK)", icon: "✈️", flight: "CA 720", detail: "7/17 Fri · 13:00 — 04:10 (+1)", time: "" },
  { from: "Beijing (PKX)", to: "Hong Kong (HKG)", icon: "✈️", flight: "CA 763", detail: "7/18 Sat · 13:40 — 17:10", time: "" },
];
  ...
  if (city === "prague")
    return (
      <svg viewBox="0 0 200 80" style={{ width: "100%", height: 80 }}>
        ...
        {[35, 55, 75, 105, 125, 145, 165].map((x) => (
          <line key={x} x1={x} y1={60} x2={x} y2="78" stroke={MORANDI.dustyRose} strokeWidth="0.5" />
        ))}
...
export default function TravelPage() {
  ...
  const handleAddPlace = (e) => {
    ...
    setCustomPlaces((p) => ({
      ...p,
      [activeCity]: [...p[activeCity], { name: newPlaceName, nameZh: "自訂新增", note: "手動添加項目" }],
    }));
    setNewPlaceName("");
  };
  ...
  const handleAddExpense = (e) => {
    ...
    setExpenses((p) => [
      ...p,
      { id: Date.now(), desc: newExpenseDesc, amount: parseFloat(newExpenseAmount), category: newExpenseCat },
    ]);
    setNewExpenseDesc("");
    setNewExpenseAmount("");
  };
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "45px 24px 20px", textAlign: "center" }}>
        <div style={{ fontSize: 10, letterSpacing: 4, textTransform: "uppercase", color: MORANDI.textLight, marginBottom: 12, fontWeight: 400 }}>
          JULY 2026 ₍ᐢ.ˬ.ᐢ₎♡🍒
        </div>
        <h1
          style={{
        ...
        >
          <div>Bea & Cora's</div>
          <div style={{ marginTop: 4, fontSize: 32, fontWeight: 300 }}>European Summer</div>
        </h1>
        <div
          style={{
            fontSize: 12,
      ...
      <div style={{ display: "flex", gap: 12, padding: "0 24px", marginBottom: 20 }}>
        <button
          ...
          style={{
            flex: 1,
            padding: "10px",
            background: activeTab === "itinerary" ? MORANDI.card : "transparent",
            color: MORANDI.text,
        ...
        <button
          ...
          style={{
            flex: 1,
            padding: "10px",
            background: activeTab === "map" ? MORANDI.card : "transparent",
            color: MORANDI.text,
            border: `1px solid ${MORANDI.border}`,
            borderRadius: 12,
            fontSize: 12,
      ...
      <div style={{ padding: "0 24px", marginBottom: 24 }}>
        <div style={{ background: MORANDI.card, borderRadius: 16, padding: "18px 20px", border: `1px solid ${MORANDI.border}` }}>
          <div style={{ fontSize: 10, letterSpacing: 2, color: MORANDI.textLight, marginBottom: 10, textTransform: "uppercase" }}>航班與交通路程</div>
          {transport.map((t, i) => (
            <div
              key={i}
              style={{
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: "flex", gap: 8, alignItems: "center", marginTop: 2 }}>
                  {t.flight && (
                    <span style={{ fontSize: 9, background: MORANDI.border, padding: "2px 6px", borderRadius: 4, color: MORANDI.text, fontWeight: 500 }}>
                      {t.flight}
                    </span>
                  )}
              ...
              {t.time && (
                <input
                  placeholder="Ref 編號"
                  value={i === 2 ? trainRefs.vp : trainRefs.pb}
                  onChange={(e) => {
                    const v = e.target.value;
                    setTrainRefs((p) => (i === 2 ? { ...p, vp: v } : { ...p, pb: v }));
                  }}
                  style={{
                    width: 75,
                    fontSize: 10,
      ...
      {/* City tabs */}
      <div style={{ display: "flex", gap: 0, padding: "0 24px", marginBottom: 24 }}>
        {cities.map((c) => (
          <button
            key={c.id}
            ...
            style={{
              ...
              fontSize: 13,
              fontWeight: activeCity === c.id ? 500 : 400,
              letterSpacing: 0.5,
            }}
          >
            {c.name}
      ...
      <div style={{ padding: "0 24px" }}>
        ...
        >
          <svg width="16" height="16" viewBox="0 0 16 16">
            ...
            {[0, 45, 90, 135, 180, 225, 270, 315].map((a) => {
              const x1 = 8 + 5 * Math.cos((a * Math.PI) / 180);
              const y1 = 8 + 5 * Math.sin((a * Math.PI) / 180);
              const x2 = 8 + 6.5 * Math.cos((a * Math.PI) / 180);
              const y2 = 8 + 6.5 * Math.sin((a * Math.PI) / 180);
        ...
        {activeTab === "itinerary" ? (
          <div>
            {city.places.map((cat, ci) => {
              ...
              const combinedItems = cat.cat === "景點" ? [...cat.items, ...customPlaces[activeCity]] : cat.items;
                ...
                <div key={key} style={{ marginBottom: 12 }}>
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                      ...
                      <span style={{ fontSize: 10, color: MORANDI.textLight, marginLeft: 6 }}>{combinedItems.length}</span>
                    </div>
                    <div style={{ transform: isOpen ? "rotate(180deg)" : "rotate(0)", transition: "transform 0.25s ease" }}>
                      <ChevronDown />
                    </div>
                  </button>
                        ...
                        return (
                          <div
                            ...
                            style={{
                              ...
                              borderBottom: ii < combinedItems.length - 1 ? `1px solid ${MORANDI.border}` : "none",
                            }}
                          >
                            <div
                              style={{
                                ...
                                height: "13px",
                                borderRadius: "50%",
                                border: `1px solid ${isChecked ? MORANDI.accent : MORANDI.textLight}`,
                                background: isChecked ? MORANDI.accent : "transparent",
                                display: "flex",
                                alignItems: "center",
                            ...
                            >
                              {isChecked && <div style={{ width: "5px", height: "5px", borderRadius: "50%", background: MORANDI.white }} />}
                            </div>
                            <div style={{ flex: 1, opacity: isChecked ? 0.5 : 1 }}>
                              <div style={{ fontSize: 13, fontWeight: 500, textDecoration: isChecked ? "line-through" : "none" }}>
                                {item.name}
                                {item.nameZh && (
                                  <span style={{ fontSize: 12, color: MORANDI.textLight, fontWeight: 400, marginLeft: 4 }}>({item.nameZh})</span>
                                )}
                              </div>
            ...
            <form
              ...
              style={{ background: MORANDI.white, padding: 16, borderRadius: 14, border: `1px solid ${MORANDI.border}`, marginTop: 20 }}
            >
              <div style={{ fontSize: 11, color: MORANDI.textLight, marginBottom: 8, letterSpacing: 1 }}>
                ➕ 為 {city.nameEn} 新增自訂景點項目
              </div>
              <div style={{ display: "flex", gap: 8 }}>
                <input
                  type="text"
                  placeholder="輸入景點/想去嘅地方名稱"
                  value={newPlaceName}
            ...
            {/* Expense tracker */}
            <div
              style={{ background: MORANDI.white, padding: 20, borderRadius: 16, border: `1px solid ${MORANDI.border}`, marginTop: 24 }}
            >
              <div
                style={{
                  display: "flex",
                  justifyContent: "space-between",
                  alignItems: "center",
                  borderBottom: `1px solid ${MORANDI.border}`,
                  paddingBottom: 10,
                  marginBottom: 12,
                }}
              >
              ...
              <div style={{ maxHeight: 150, overflowY: "auto", marginBottom: 12 }}>
                {expenses.map((exp) => (
                  <div key={exp.id} style={{ display: "flex", justifyContent: "space-between", fontSize: 12, padding: "6px 0", color: MORANDI.text }}>
                    <span>
                      {exp.desc}{" "}
                      <span style={{ fontSize: 9, background: MORANDI.card, padding: "2px 4px", borderRadius: 4, color: MORANDI.textLight }}>
                        {exp.category}
                      </span>
                    </span>
                    <span style={{ fontWeight: 500 }}>${exp.amount.toLocaleString()}</span>
                  </div>
                ))}
              </div>
              ...
              <form
                ...
                style={{ display: "flex", flexDirection: "column", gap: 8, borderTop: `1px solid ${MORANDI.border}`, paddingTop: 12 }}
              >
                <div style={{ display: "flex", gap: 6 }}>
                  <input
                    type="text"
                    placeholder="新支出項目 (如: 午餐)"
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <select
                    ...
                    style={{ padding: "4px 8px", border: `1px solid ${MORANDI.border}`, borderRadius: 6, fontSize: 11, background: MORANDI.white }}
                  >
